...
describe('Check event data', function () {
    ...
    it('EventEmitter objects export \'setEventData\' and \'getEventData\' methods', function () {
        expect(typeof emitter.setEventData).toBe('function');
        expect(typeof emitter.getEventData).toBe('function');
    });

    describe('Check \'setEventData\' method', function () {
    ...
    describe('Check \'getEventData\' method', function () {
